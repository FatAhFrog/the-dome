...
export const THEMES: Record<ThemeKey, ThemeDefinition> = {
  ...
  retro_game: {
    key: 'retro_game',
    label: 'Retro-Game',
    description: 'A monochrome Game Boy-inspired palette of deep greens and pale lime.',
    shop: 'snake',
    background: '#e0f8cf',
    panelBackground: '#c7e89a',
    text: '#0f380f',
    panelText: '#0f380f',
    border: '#8bac0f',
    accent: '#306230',
    accentSecondary: '#0f380f',
    onAccent: '#e0f8cf',
    pieces: { I: '#0f380f', O: '#1f4f1f', T: '#306230', S: '#4f7727', Z: '#6f8f2e', J: '#8bac0f', L: '#9bbc0f' },
